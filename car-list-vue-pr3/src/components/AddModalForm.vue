<template>
  ...
  <button
    @click="isOpen = true"
    class="px-6 py-2 text-white bg-blue-600 rounded shadow text-right"
    type="button"
  >
    Open Model
  </button>
